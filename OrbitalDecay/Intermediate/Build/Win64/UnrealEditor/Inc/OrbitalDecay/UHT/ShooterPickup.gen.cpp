...
ORBITALDECAY_API UClass* Z_Construct_UClass_AShooterPickup();
...
ORBITALDECAY_API UScriptStruct* Z_Construct_UScriptStruct_FWeaponTableRow();
...
class UScriptStruct* FWeaponTableRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FWeaponTableRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeaponTableRow, (UObject*)Z_Construct_UPackage__Script_OrbitalDecay(), TEXT("WeaponTableRow"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_VN_Documents_Work_Projects_Unreal_OrbitalDecay_OrbitalDecay_Source_OrbitalDecay_Variant_Shooter_Weapons_ShooterPickup_h__Script_OrbitalDecay_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWeaponTableRow::StaticStruct, Z_Construct_UScriptStruct_FWeaponTableRow_Statics::NewStructOps, TEXT("WeaponTableRow"),&Z_Registration_Info_UScriptStruct_FWeaponTableRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeaponTableRow), 1908979605U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterPickup, AShooterPickup::StaticClass, TEXT("AShooterPickup"), &Z_Registration_Info_UClass_AShooterPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterPickup), 2534249732U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_VN_Documents_Work_Projects_Unreal_OrbitalDecay_OrbitalDecay_Source_OrbitalDecay_Variant_Shooter_Weapons_ShooterPickup_h__Script_OrbitalDecay_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_VN_Documents_Work_Projects_Unreal_OrbitalDecay_OrbitalDecay_Source_OrbitalDecay_Variant_Shooter_Weapons_ShooterPickup_h__Script_OrbitalDecay_1665080716{
	TEXT("/Script/OrbitalDecay"),
	Z_CompiledInDeferFile_FID_Users_VN_Documents_Work_Projects_Unreal_OrbitalDecay_OrbitalDecay_Source_OrbitalDecay_Variant_Shooter_Weapons_ShooterPickup_h__Script_OrbitalDecay_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_VN_Documents_Work_Projects_Unreal_OrbitalDecay_OrbitalDecay_Source_OrbitalDecay_Variant_Shooter_Weapons_ShooterPickup_h__Script_OrbitalDecay_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_VN_Documents_Work_Projects_Unreal_OrbitalDecay_OrbitalDecay_Source_OrbitalDecay_Variant_Shooter_Weapons_ShooterPickup_h__Script_OrbitalDecay_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_VN_Documents_Work_Projects_Unreal_OrbitalDecay_OrbitalDecay_Source_OrbitalDecay_Variant_Shooter_Weapons_ShooterPickup_h__Script_OrbitalDecay_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
